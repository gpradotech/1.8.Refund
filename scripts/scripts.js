...
function updateTotals(){
  try{
    // Recupera todos os itens (li) da nossa lista (ul).
    ...
    // Formata o valor e remove o R$, pois o mesmo será exibido posteriormente pela small com um estilo customizado.
